...
LD_PRELOAD=/usr/lib/x86_64-linux-gnu/libprofiler.so CPUPROFILE=vector_v3.profile ./vector_v3 10000 $NGENS
...
~/bin/pprof --pdf vector_v3 vector_v3.profile > vector_v3_profile.pdf
